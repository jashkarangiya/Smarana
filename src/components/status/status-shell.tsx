...
export function StatusShell({ code, title, description, hint, actions }: Props) {
    return (
        <div className="relative min-h-[calc(100vh-80px)] w-full overflow-hidden flex flex-col items-center justify-center bg-background text-foreground">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none z-0 opacity-20">
                <FloatingCode code={`${code}`} x="10%" y="20%" delay={0} color="text-red-500" />
                ...
                >
                    ...
                    {hint && (
                        <p className="mt-4 text-sm text-white/45">
                            <span className="text-white/60 font-mono">Tip:</span> {hint}
                        </p>
                    )}
                </motion.div>
